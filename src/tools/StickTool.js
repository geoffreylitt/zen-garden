...
import { createStickTexture } from '../graphics/sprites/StickSprite.js';

export class StickTool {
  ...
  onDown(pointer) {
    ...
    const key = createStickTexture(this.scene);
    // Anchor at the base of the stick so it looks planted in the sand
